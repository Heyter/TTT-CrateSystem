...
function IsCommon( item )
   if table_HasValue( GarrBearsCrates.Crates.Common, item ) then
      return true
   else
      return false
   end
...
function IsRare( item )
   if table_HasValue( GarrBearsCrates.Crates.Rare, item ) then
      return true
   else
      return false
   end
...
function IsEpic( item )
   if table_HasValue( GarrBearsCrates.Crates.Epic, item ) then 
      return true
   else
      return false
   end
...
function IsLegandary( item )
   if table_HasValue( GarrBearsCrates.Crates.Lengandy, item ) then
      return true
   else
      return false
   end
...
function IsPrimaryWeapon( weapon )
   if table_HasValue( GarrBearsCrates.Weapons.Primary, weapon:GetClass() ) then
      return true
   else
      return false
   end
...
function IsSecondaryWeapon( weapon )
   if table_HasValue( GarrBearsCrates.Weapons.Secondary, weapon:GetClass() ) then
      return true
   else
      return false
   end
...
function IsMeleeWeapon( weapon )
   if table_HasValue( GarrBearsCrates.Weapons.Melee, weapon:GetClass() ) then
      return true
   else
      return false
   end
...
function IsSpecialWeapon( weapon )
   if table_HasValue( GarrBearsCrates.Weapons.Special, weapon:GetClass() ) then
      return true
   else
      return false
   end
