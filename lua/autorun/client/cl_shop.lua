...
function ShopMenuBox( item )
   ...
   local ShopMenuDerma = vgui_Create( "DFrame", GetPartent() )
   ...
   local SellingBackGround = vgui_Create( "DImage", ShopMenuDerma )
   ...
   local CancelButton = vgui_Create( "DButton", ShopMenuDerma )
   CancelButton:SetSize( 50, 20 )

   local CloseButton = vgui_Create( "DButton", ShopMenuDerma )
