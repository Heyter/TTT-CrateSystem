local ipairs, file, string, table_insert, tonumber, net = ipairs, file, string, table.insert, tonumber, net
--[[-------------------------------------------------------------------------
...
function GetPlayersItems( ply )
   ...
   for k,v in ipairs( files ) do 
      if string.Left( v, 5 ) == "ITEM_" then
         ...
         table_insert( ThePlayersItemsToBeSent, { ItemID, tonumber(NumberOfItems) } )
      end
   end
end
