...
net.Receive( "FailedOpeningCrate", function( len ) 
   local FailedToOpen = vgui.Create( "DFrame", GetPartent() )
   ...
   local FailedToOpenBackGround = vgui.Create( "DImage", FailedToOpen )
   ...
   local CloseButton = vgui.Create("DButton", FailedToOpen)
