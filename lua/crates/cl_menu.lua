...
function Tab_Shower( pos, parent )
...
function InventoryBackGround( parent )
...
function CrateInventory( parent )
   local ItemAmount = 0
...
function CrateCrafting( parent ) 

end

function CrateLoadout( parent )

end

function CrateShop( parent )
    
end

function CrateAdmin( parent )

end

function CrateSuperAdmin( parent )
